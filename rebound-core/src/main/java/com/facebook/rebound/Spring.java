...
/**
 * Classical spring implementing Hooke's law(胡克定律) with configurable friction(摩擦力) and tension(张力).
 */
public class Spring {

    // unique incrementer(增量器) id for springs
    private static int ID = 0;

    // maximum amount of time to simulate(模拟) per physics iteration(迭代，重复) in seconds (4 frames at 60 FPS(60帧/秒的4帧))
