...
/**
 * BaseSpringSystem maintains the set of springs within an Application context. It is responsible(可靠的,负责任的) for
 * Running the spring integration(集成,综合) loop and maintains a registry of all the Springs it solves for.
 * In addition(除了) to listening to physics events on the individual Springs in the system, listeners
...
public class BaseSpringSystem {
    ...
    private final Set<Spring> mActiveSprings = new CopyOnWriteArraySet<>();// TODO: 2018/4/26  to un
    ...
    /**
     * check if the system is idle(闲置的)
     */
    ...
    /**
     * create a spring with a random uuid for its name.每一个Spring都应处于一个SpringSystem中，因此创建完成Spring以后需要将它添加到SpringSystem中去
     */
    ...
    /**
     * update the springs in the system.advance:推进，前进，发展
     *
    ...
    /**
     * loop the system until idle,直到所有的String不再弹弹弹...
     */
